...
spark.sql(f"""
          ...
          USING DELTA
          LOCATION 'abfss://{contenedorDatalake}@{cuentaDatalake}.dfs.core.windows.net/Silver/Deltas/Data_Vault/common/hub_clientes'
          """)
...
# MAGIC %sql
# MAGIC SELECT * FROM zona_plata.data_vault.hub_clientes;
