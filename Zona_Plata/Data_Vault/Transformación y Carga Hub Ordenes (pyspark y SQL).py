...
spark.sql(f"""
          ...
          LOCATION 'abfss://{contenedorDatalake}@{cuentaDatalake}.dfs.core.windows.net/Silver/Deltas/Data_Vault/common/hub_ordenes'
          """)
...
spark.sql(f"""
            INSERT INTO hub_ordenes (hk_ordenes, bk_codigo_orden, fecha_registro, nombre_fuente, anio_particion, mes_particion)
            SELECT 
                B.hk_ordenes
                ,B.bk_codigo_orden 
                ,B.fecha_registro
...
# MAGIC %sql
# MAGIC SELECT * FROM zona_plata.data_vault.hub_ordenes;
